...
if(NOT GTEST_FOUND)
  ...
  if(gtest_root)
    ...
    configure_file(${CMAKE_CURRENT_SOURCE_DIR}/cmake.fpta/googletest-download.cmake.in ${CMAKE_BINARY_DIR}/googletest-download/CMakeLists.txt)
  ...
  if(gtest_root)
    ...
    if(CC_HAS_WERROR)
      ...
      if(CMAKE_VERSION VERSION_GREATER 2.8.11)
        ...
        set_target_properties(gtest PROPERTIES COMPILE_FLAGS ${local_warn_no_error})
        set_target_properties(gtest_main PROPERTIES COMPILE_FLAGS ${local_warn_no_error})
      endif()
