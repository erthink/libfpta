...
- [x] недопустимость update с изменением ключа.
...
- [x] обновление с изменением PK.
- [x] обновление с изменением 1-2-3-максимумом колонок.
...
##9crud
- [x] создание таблиц с одним PK для всех типов полей и всех типов индексов.
- [x] вставка 1-2-3 небольших записей, проба дубликатов, обновление, проверка наличия, удаление.
...
- [x] обновление с изменением 1-2-3-всех колонок.
- [x] вставка/обновление с нарушением уникальности.
- [ ] тест с инжектированием ошибок при изменениях.
- [x] добавление нулевых и не-нулевых как значений,так и ключей в различном порядке.
