...
struct iovec fpt_field_opaque(const fpt_field* pf) {
    ...
    default:
        ...
        opaque.iov_len = payload->other.varlen.brutto * (size_t) 4;
        break;
    case fpt_null:
    ...
    case fpt_nested:
        payload = fpt_field_payload(pf);
        opaque.iov_len = payload->other.varlen.brutto * (size_t) 4 + 4;
...
fpt_ro fpt_field_nested(const fpt_field* pf) {
    ...
    tuple.total_bytes = payload->other.varlen.brutto * (size_t) 4 + 4;
