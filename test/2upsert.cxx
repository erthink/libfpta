...
TEST(Upsert, Base)
{
    ...
    EXPECT_EQ(fptu_ok, fptu_upsert_fp64(pt, fptu_max_cols - 3,
...
TEST(Upsert, Overwrite)
{
    ...
    while (n < 1001) {
        ...
        ASSERT_EQ(fptu_ok,
                  fptu_upsert_opaque_iov(pt, 0, opaque_iov(0, n, 23)));
        ASSERT_STREQ(nullptr, fptu_check(pt));
        ro = fptu_take_noshrink(pt);
        ASSERT_STREQ(nullptr, fptu_check_ro(ro));
        EXPECT_EQ(fptu_eq, fptu_cmp_opaque_iov(ro, 0, opaque_iov(0, n, 23)));
        ...
        SCOPED_TRACE("touch field #2, len " +
                     ...
                     std::to_string(fptu_junkspace(pt)));
        ASSERT_EQ(fptu_ok,
                  fptu_upsert_opaque_iov(pt, 2, opaque_iov(2, n, 41)));
        ASSERT_STREQ(nullptr, fptu_check(pt));
        ro = fptu_take_noshrink(pt);
        ASSERT_STREQ(nullptr, fptu_check_ro(ro));
        EXPECT_EQ(fptu_eq, fptu_cmp_opaque_iov(ro, 0, opaque_iov(0, n, 23)));
        ...
        SCOPED_TRACE("touch field #1, len " +
                     ...
                     std::to_string(fptu_junkspace(pt)));
        ASSERT_EQ(fptu_ok,
                  fptu_upsert_opaque_iov(pt, 1, opaque_iov(1, n, 37)));
        ASSERT_STREQ(nullptr, fptu_check(pt));
        ro = fptu_take_noshrink(pt);
        ASSERT_STREQ(nullptr, fptu_check_ro(ro));
        EXPECT_EQ(fptu_eq, fptu_cmp_opaque_iov(ro, 0, opaque_iov(0, n, 23)));
...
TEST(Upsert, InsertUpdate)
{
    ...
    ro = fptu_take_noshrink(pt);
    ASSERT_STREQ(nullptr, fptu_check_ro(ro));
    EXPECT_EQ((float)2.7182818284590452354 + 43,
              fptu_get_fp32(ro, 0, nullptr));
    EXPECT_EQ(0, fptu_junkspace(pt));
    ...
    EXPECT_EQ((float)2.7182818284590452354 - 42,
              fptu_get_fp32(ro, 0, nullptr));
