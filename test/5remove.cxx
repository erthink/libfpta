...
TEST(Remove, Serie)
{
    ...
    for (unsigned n = 1; n < 11; ++n) {
        ...
        EXPECT_STREQ(nullptr, fptu_check(pt));
        EXPECT_EQ(n * 3, fptu_field_count_ex(pt, field_filter_any, nullptr,
                                             nullptr));

        EXPECT_EQ(n, fptu_erase(pt, 1, fptu_filter | (1 << fptu_uint32)));
        EXPECT_STREQ(nullptr, fptu_check(pt));
        EXPECT_EQ(n * 2, fptu_field_count_ex(pt, field_filter_any, nullptr,
                                             nullptr));
        ...
        EXPECT_STREQ(nullptr, fptu_check(pt));
        ASSERT_EQ(
            0, fptu_field_count_ex(pt, field_filter_any, nullptr, nullptr));
...
TEST(Remove, Shuffle)
{
    ...
    for (unsigned create_iter = 0; create_iter < (1 << 6); ++create_iter) {
        ...
        for (unsigned n = 0; n < shuffle6::factorial; ++n) {
            ...
            EXPECT_EQ(created_count, fptu_field_count_ex(pt, field_filter_any,
                                                         nullptr, nullptr));
            ...
            while (!order.empty()) {
                ...
                ASSERT_EQ(created_count - removed_count,
                          fptu_field_count_ex(pt, field_filter_any, nullptr,
                                              nullptr));
            }
