...
TEST(Data, UpsertColumn)
{
    ...
    EXPECT_EQ(FPTA_OK, fpta_column_describe("uint16", fptu_uint16,
                                            fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK, fpta_column_describe("int32", fptu_int32,
                                            fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK, fpta_column_describe("uint32", fptu_uint32,
                                            fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK,
              fpta_column_describe("fp32", fptu_fp32, fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK, fpta_column_describe("int64", fptu_int64,
                                            fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK, fpta_column_describe("uint64", fptu_uint64,
                                            fpta_index_none, &def));
    EXPECT_EQ(FPTA_OK,
    ...
    EXPECT_EQ(FPTA_OK, fpta_column_describe("opaque", fptu_opaque,
                                            fpta_index_none, &def));

    EXPECT_EQ(FPTA_OK, fpta_column_describe("nested", fptu_nested,
                                            fpta_index_none, &def));
    ...
    EXPECT_EQ(FPTA_OK,
              fpta_upsert_column(pt, &col_uint16, fpta_value_sint(0)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_uint16,
                                          fpta_value_sint(UINT16_MAX)));
    EXPECT_EQ(FPTA_OK,
    ...
    // теперь подходящие значения, последнее должно остаться в силе
    EXPECT_EQ(FPTA_OK,
              fpta_upsert_column(pt, &col_uint32, fpta_value_sint(0)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_uint32,
                                          fpta_value_sint(UINT32_MAX)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_uint32,
                                          fpta_value_uint(1354824703)));
    // колонка int32
    // пробуем плохие типы
    EXPECT_EQ(FPTA_ETYPE,
    ...
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_uint(UINT32_MAX - 1l)));
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_uint(UINT32_MAX + 1l)));
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_uint(INT32_MAX + 1l)));
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_sint(UINT32_MAX - 1l)));
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_sint(UINT32_MAX + 1l)));
    EXPECT_EQ(
        FPTA_EVALUE,
        fpta_upsert_column(pt, &col_int32, fpta_value_sint(INT32_MIN - 1l)));
    // теперь подходящие значения, последнее должно остаться в силе
    EXPECT_EQ(FPTA_OK,
              fpta_upsert_column(pt, &col_int32, fpta_value_sint(INT32_MIN)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_int32,
                                          fpta_value_sint(INT32_MIN + 1)));
    EXPECT_EQ(FPTA_OK,
    ...
    EXPECT_EQ(FPTA_EVALUE, fpta_upsert_column(pt, &col_uint64,
                                              fpta_value_sint(INT32_MIN)));
    EXPECT_EQ(FPTA_EVALUE, fpta_upsert_column(pt, &col_uint64,
                                              fpta_value_sint(INT64_MIN)));
    // теперь подходящие значения, последнее должно остаться в силе
    EXPECT_EQ(FPTA_OK,
              fpta_upsert_column(pt, &col_uint64, fpta_value_sint(0)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_uint64,
                                          fpta_value_sint(INT64_MAX)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_uint64,
                                          fpta_value_uint(UINT64_MAX)));
    EXPECT_EQ(FPTA_OK,
    ...
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_96,
                                          fpta_value_binary(_96, 96 / 8)));
    EXPECT_EQ(FPTA_OK, fpta_upsert_column(pt, &col_128,
...
TEST(Data, Compare_uint16)
{
    ...
    ASSERT_NE(nullptr, pf);
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_uint(42)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(42)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(42)));
    EXPECT_EQ(fptu_ic, fpta_filter_cmp(pf, fpta_value_cstr("dummy")));
    EXPECT_EQ(fptu_ic, fpta_filter_cmp(pf, fpta_value_null()));
    EXPECT_EQ(fptu_ic, fpta_filter_cmp(
                           pf, fpta_value_binary(pattern, sizeof(pattern))));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(43)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(43)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(43)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(FLT_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(DBL_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(HUGE_VAL)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(41)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(41)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(41)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(-42)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-42)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-FLT_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-DBL_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-HUGE_VAL)));
    EXPECT_EQ(FPTU_OK, fptu_upsert_uint16(pt, 0, 0));
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_uint16));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(-1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MIN)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-FLT_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-DBL_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-FLT_MIN)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-DBL_MIN)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(FLT_MIN)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(DBL_MIN)));
    fptu_erase_field(pt, pf);
...
TEST(Data, Compare_uint32)
{
    ...
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_uint32));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(UINT32_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(UINT32_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(UINT32_MAX - 1l)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX - 1l)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_float(UINT32_MAX - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(UINT32_MAX + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX + 1l)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_float(UINT32_MAX + 1l)));
    fptu_erase_field(pt, pf);
...
TEST(Data, Compare_uint64)
{
    ...
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_uint64));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(INT64_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX - 1l)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX + 1ul)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(UINT64_MAX)));
    fptu_erase_field(pt, pf);
...
TEST(Data, Compare_int32)
{
    ...
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_int32));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(INT32_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_uint(INT32_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(INT32_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT32_MAX - 1l)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT32_MAX - 1l)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(INT32_MAX - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(INT32_MAX + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(INT32_MAX + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(INT32_MAX + 1l)));
    EXPECT_EQ(FPTU_OK, fptu_upsert_int32(pt, 0, INT32_MIN));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(0)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(0)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(0)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(INT32_MIN)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(INT32_MIN)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT32_MIN - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX - 1l)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(INT32_MIN - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(INT32_MIN + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT32_MAX + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(INT32_MIN + 1l)));
    fptu_erase_field(pt, pf);
...
TEST(Data, Compare_int64)
{
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX - 1l)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX + 1ull)));
    EXPECT_EQ(FPTU_OK, fptu_upsert_int64(pt, 0, INT64_MIN));
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_int64));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(0)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(0)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(0)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_sint(INT64_MIN)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(INT64_MIN)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX - 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MIN + 1l)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));
    fptu_erase_field(pt, pf);
...
TEST(Data, Compare_fp64)
{
    ...
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(INT64_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX / 2.0)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX / 2.0)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX + 2048ull)));
    ...
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX - 1l)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_sint(INT64_MIN + 2048ull)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));

    EXPECT_EQ(FPTU_OK, fptu_upsert_fp64(pt, 0, HUGE_VAL));
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_fp64));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(HUGE_VAL)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(DBL_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(FLT_MAX)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(0)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-HUGE_VAL)));
...
TEST(Data, Compare_fp32)
{
    ...
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(
                  pf, fpta_value_uint((uint64_t)INT64_MAX + UINT32_MAX)));
    ...
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX - 1l)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_sint(INT64_MIN + UINT32_MAX)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(UINT64_MAX)));
    ...
    ASSERT_EQ(pf, fptu_lookup(pt, 0, fptu_fp32));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_float(0)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-DBL_MIN)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(-FLT_MIN)));
#endif
...
TEST(Data, Compare_string)
{
    ...
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_cstr("42\1")));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_cstr("41")));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_cstr("41\xff")));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_cstr("")));

    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary("42", 2)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("42", 3)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("43", 2)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("41", 2)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("41\xff", 2)));
...
TEST(Data, Compare_binary)
{
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 0)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\0", 2)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(zeros, 3)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 4)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 5)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 2)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\0", 2)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 3)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 4)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 5)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(ones, 2)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(ones, 3)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(ones, 4)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(ones, 5)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 2)));
    fptu_erase_field(pt, pf);
    ASSERT_STREQ(nullptr, fptu_check(pt));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 96 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(zeros, 96 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 96 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 96 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(ones, 96 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 96 / 8 + 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 96 / 8)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8 + 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8 - 1)));
    EXPECT_EQ(fptu_eq,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 128 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(ones, 128 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 128 / 8 + 1)));
    ...
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(_128, 128 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(_128, 128 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(_128, 128 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(ones, 2)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8 - 1)));
    EXPECT_EQ(fptu_eq,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 160 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(ones, 160 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 160 / 8 + 1)));
    ...
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(_160, 160 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(_160, 160 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(_160, 160 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(ones, 2)));
    ...
    EXPECT_EQ(fptu_eq,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 192 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 192 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8 - 1)));
    EXPECT_EQ(fptu_eq,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    ...
    EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 256 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(ones, 256 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(ones, 256 / 8 + 1)));
    ...
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8)));
    EXPECT_EQ(fptu_gt,
              fpta_filter_cmp(pf, fpta_value_binary(_256, 256 / 8 - 1)));
    EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(_256, 256 / 8)));
    EXPECT_EQ(fptu_lt,
              fpta_filter_cmp(pf, fpta_value_binary(_256, 256 / 8 + 1)));
    EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(ones, 2)));
