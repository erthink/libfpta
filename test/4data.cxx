...
TEST(Data, UpsertColumn) {
  ...
  EXPECT_EQ(
      FPTA_EVALUE,
      fpta_upsert_column(pt, &col_uint16, fpta_value_uint(UINT16_MAX + 1l)));
  ...
  EXPECT_EQ(
      FPTA_EVALUE,
      fpta_upsert_column(pt, &col_uint32, fpta_value_uint(UINT32_MAX + 1l)));
  EXPECT_EQ(FPTA_EVALUE,
  ...
  EXPECT_EQ(
      FPTA_EVALUE,
      fpta_upsert_column(pt, &col_int64, fpta_value_uint(INT64_MAX + 1ull)));
  EXPECT_EQ(FPTA_EVALUE,
...
TEST(Data, Compare_uint32) {
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_float(UINT32_MAX - 1l)));
  ...
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_float(UINT32_MAX + 1l)));
  fptu_erase_field(pt, pf);
...
TEST(Data, Compare_int64) {
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX - 1l)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX - 1l)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX + 1ull)));
...
TEST(Data, Compare_fp32) {
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_sint(INT64_MAX / 2.0)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_uint(INT64_MAX / 2.0)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_uint((uint64_t)INT64_MAX +
                                                         UINT32_MAX)));
...
TEST(Data, Compare_binary) {
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8 - 1)));
  EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary(_96, 96 / 8 + 1)));
  ...
  EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8)));
  EXPECT_EQ(fptu_lt,
            fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8 + 1)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 2)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 128 / 8)));
  EXPECT_EQ(fptu_gt,
  ...
  EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8)));
  EXPECT_EQ(fptu_lt,
            fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8 + 1)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 2)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 160 / 8)));
  EXPECT_EQ(fptu_gt,
  ...
  EXPECT_EQ(fptu_eq, fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8)));
  EXPECT_EQ(fptu_lt,
            fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8 + 1)));
  EXPECT_EQ(fptu_lt, fpta_filter_cmp(pf, fpta_value_binary("\xff", 1)));
  ...
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary("", 1)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 2)));
  EXPECT_EQ(fptu_gt, fpta_filter_cmp(pf, fpta_value_binary(zeros, 256 / 8)));
  EXPECT_EQ(fptu_gt,
