...
if(CMAKE_COMPILER_IS_GNUCC)
  ...
  if(NOT CMAKE_CXX_COMPILER_VERSION VERSION_LESS 4.7)
    ...
    if(NOT CMAKE_GCC_AR)
      find_program(CMAKE_GCC_AR NAMES gcc${gcc_suffix}-ar PATHS ${gcc_dir} NO_DEFAULT_PATH)
    endif()
    if(NOT CMAKE_GCC_NM)
      find_program(CMAKE_GCC_NM NAMES gcc${gcc_suffix}-nm PATHS ${gcc_dir} NO_DEFAULT_PATH)
    endif()
    if(NOT CMAKE_GCC_RANLIB)
      find_program(CMAKE_GCC_RANLIB NAMES gcc${gcc_suffix}-ranlib PATHS ${gcc_dir} NO_DEFAULT_PATH)
    endif()
...
macro(setup_compile_flags)
  ...
  if(MSVC AND MSVC_LTO_ENABLED)
    ...
    set(EXE_LINKER_FLAGS "${EXE_LINKER_FLAGS} /LTCG")
    set(SHARED_LINKER_FLAGS "${SHARED_LINKER_FLAGS} /LTCG")
    set(STATIC_LINKER_FLAGS "${STATIC_LINKER_FLAGS} /LTCG")
    set(MODULE_LINKER_FLAGS "${MODULE_LINKER_FLAGS} /LTCG")
      ...
      foreach(lang IN ITEMS C CXX)
        ...
        if(DEFINED "CMAKE_${lang}_FLAGS_${config_uppercase}")
          ...
          if(NOT "${altered_flags}" STREQUAL "${CMAKE_${lang}_FLAGS_${config_uppercase}}")
            set("CMAKE_${lang}_FLAGS_${config_uppercase}" "${altered_flags}" CACHE STRING "Altered for LTO" FORCE)
          endif()
        endif()
      endforeach(lang)
    endforeach(config)
