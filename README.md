...
появляется выбор: пожертвовать местом или использовать процедуру
дефрагментации.
...
1. Доступны функции верификации сериализованной и формируемой форм
...
бинарных строк, вложенных кортежей), в первом 32-битном слове данных
