...
enum fptu_bits {
	...
	fptu_buffer_enought = sizeof(fptu_rw)
		+ fptu_max_tuple_bytes + fptu_max_fields * fptu_unit_size,
...
enum fptu_type {
	...
	fptu_any_int  = fptu_filter
		| (1 << fptu_int32)
		| (1 << fptu_int64),  // match int32/int64
	fptu_any_uint = fptu_filter
		| (1 << fptu_uint32)
		| (1 << fptu_uint64), // match uin32/uin64
	fptu_any_fp   = fptu_filter
		| (1 << fptu_fp32)
		| (1 << fptu_fp64),   // match fp32/fp64
...
int fptu_upsert_opaque(fptu_rw* pt, unsigned column, const void* value, size_t bytes);
int fptu_upsert_opaque_iov(fptu_rw* pt, unsigned column, const struct iovec value);
// TODO
//int fptu_upsert_nested(fptu_rw* pt, unsigned column, fptu_ro ro);

// TODO
//int fptu_upsert_array_uint16(fptu_rw* pt, unsigned ct, size_t array_length, const uint16_t* array_data);
//int fptu_upsert_array_int32(fptu_rw* pt, unsigned ct, size_t array_length, const int32_t* array_data);
//int fptu_upsert_array_uint32(fptu_rw* pt, unsigned ct, size_t array_length, const uint32_t* array_data);
//int fptu_upsert_array_int64(fptu_rw* pt, unsigned ct, size_t array_length, const int64_t* array_data);
//int fptu_upsert_array_uint64(fptu_rw* pt, unsigned ct, size_t array_length, const uint64_t* array_data);
//int fptu_upsert_array_str(fptu_rw* pt, unsigned ct, size_t array_length, const char* array_data[]);
//int fptu_upsert_array_nested(fptu_rw* pt, unsigned ct, size_t array_length, const char* array_data[]);
...
int fptu_insert_opaque(fptu_rw* pt, unsigned column, const void* value, size_t bytes);
int fptu_insert_opaque_iov(fptu_rw* pt, unsigned column, const struct iovec value);
// TODO
//int fptu_insert_nested(fptu_rw* pt, unsigned column, fptu_ro ro);

// TODO
//int fptu_insert_array_uint16(fptu_rw* pt, unsigned ct, size_t array_length, const uint16_t* array_data);
//int fptu_insert_array_int32(fptu_rw* pt, unsigned ct, size_t array_length, const int32_t* array_data);
//int fptu_insert_array_uint32(fptu_rw* pt, unsigned ct, size_t array_length, const uint32_t* array_data);
//int fptu_insert_array_int64(fptu_rw* pt, unsigned ct, size_t array_length, const int64_t* array_data);
//int fptu_insert_array_uint64(fptu_rw* pt, unsigned ct, size_t array_length, const uint64_t* array_data);
//int fptu_insert_array_str(fptu_rw* pt, unsigned ct, size_t array_length, const char* array_data[]);
...
int fptu_update_opaque(fptu_rw* pt, unsigned column, const void* value, size_t bytes);
int fptu_update_opaque_iov(fptu_rw* pt, unsigned column, const struct iovec value);
// TODO
//int fptu_update_nested(fptu_rw* pt, unsigned column, fptu_ro ro);

// TODO
//int fptu_update_array_uint16(fptu_rw* pt, unsigned ct, size_t array_length, const uint16_t* array_data);
//int fptu_update_array_int32(fptu_rw* pt, unsigned ct, size_t array_length, const int32_t* array_data);
//int fptu_update_array_uint32(fptu_rw* pt, unsigned ct, size_t array_length, const uint32_t* array_data);
//int fptu_update_array_int64(fptu_rw* pt, unsigned ct, size_t array_length, const int64_t* array_data);
//int fptu_update_array_uint64(fptu_rw* pt, unsigned ct, size_t array_length, const uint64_t* array_data);
//int fptu_update_array_str(fptu_rw* pt, unsigned ct, size_t array_length, const char* array_data[]);
 ...
 * Семантика type_or_filter указана в описании fptu_erase(). */
const fptu_field* fptu_first(const fptu_field* begin, const fptu_field* end, unsigned column, int type_or_filter);
const fptu_field* fptu_next(const fptu_field* from, const fptu_field* end, unsigned column, int type_or_filter);
...
const fptu_field* fptu_first_ex(const fptu_field* begin, const fptu_field* end,
							  fptu_field_filter filter, void* context, void *param);
...
size_t fptu_field_count_ex(const fptu_rw* pt, fptu_field_filter filter, void* context, void *param);
size_t fptu_field_count_ro_ex(fptu_ro ro, fptu_field_filter filter, void* context, void *param);
