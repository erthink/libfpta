...
#include <assert.h>
#include <alloca.h>
#include <sys/uio.h> // LY: for struct iovec
...
// TODO
//int fpt_upsert_array(fpt_rw* pt, unsigned ct, size_t array_length, const void* array_data);
...
// TODO
// xxx_insert() - добавление еще одного поля без перезаписи (поддержка коллекций).
// xxx_update() - обновление существующего поля
