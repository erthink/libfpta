...
typedef enum fpta_durability {
  ...
  fpta_lazy /* "Ленивый" режим записи.
              * Достаточно быстрый режим, но с риском с потерей последних
  ...
  fpta_async /* Самый быстрый режим, но без гарантий сохранности всей базы
              * при аварии.
              *
 ...
 *
 * Например, fpta_frendly4hdd (стремление к последовательной записи)
 * вместе с fpta_frendly4compaction (стремление к использованию страниц с
 * меньшими номерами "")
 */
