...
enum fpta_bits {
   ...
   * переменной длины и составных колонок.
   *
...
typedef enum fpta_durability {
  ...
  fpta_lazy, /* "Ленивый" режим записи посредством файловой
              ...
              * транзакции, при этом целостность БД определяется
              * соблюдением data ordered со стороны Файловой Системы.
              *
 ...
 * составная колонка является средством описания составного индекса.
 *
...
/* Возвращает количество колонок в таблице, включая составные колонки.
 *
