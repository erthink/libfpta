 ...
 * из изменение требует пересборки библиотеки.
 *
 ...
 * При таком замещении этом:
 *  - в err будет передан первичный код ошибки, из-за которой
 *    потребовалось отменить транзакцию.
